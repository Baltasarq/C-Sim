...
namespace CSim.Core.Literals {
    ...
    public class LongLiteral: Literal {
		/// <summary>
		/// Initializes a new instance of the <see cref="T:CSim.Core.Literals.LongLiteral"/> class.
		/// </summary>
		/// <param name="m">The <see cref="Machine"/>.</param>
		/// <param name="x">A given integer.</param>
		public LongLiteral(Machine m, object x)
		...
		/// <param name="m">The <see cref="Machine"/>.</param>
		/// <param name="x">A given integer.</param>
        public LongLiteral(Machine m, BigInteger x)
			:base( m, x )
        {
        }
        ...
        public override AType Type {
            get {
                return this.Machine.TypeSystem.GetLongType();
            }
        }
        ...
        {
			return this.Machine.Bytes.FromLongToBytes( this.Value );
        }
		...
		/// </summary>
		/// <returns>A <see cref="System.String"/> that represents the current <see cref="CSim.Core.Literals.LongLiteral"/>.</returns>
