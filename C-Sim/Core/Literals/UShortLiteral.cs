...
namespace CSim.Core.Literals {
    ...
    /// </summary>
    public class UShortLiteral: Literal {
		/// <summary>
		...
		public UShortLiteral(Machine m, object x)
			:this( m, GetValueAsShortIntFromUnsigned( m, x ) )
		{
		}
		...
		/// <param name="m">The <see cref="Machine"/>.</param>
		/// <param name="x">A given integer.</param>
		public UShortLiteral(Machine m, BigInteger x)
			:base( m, x )
        {
        }
        ...
        public override AType Type {
            get {
                return this.Machine.TypeSystem.GetUShortType();
            }
        }
        ...
        {
			return this.Machine.Bytes.FromUShortToBytes( this.Value );
        }
        ...
        {
            return GetValueAsShortIntFromUnsigned( this.Machine, this.Value );
        }
        ...
        public static BigInteger GetValueAsShortIntFromUnsigned(Machine m, object x)
        {
            return m.Bytes.FromBytesToUShort( m.Bytes.FromShortToBytes( x.ToBigInteger() ) );
        }
    }
}
