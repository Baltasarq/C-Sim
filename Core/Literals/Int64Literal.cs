...
namespace CSim.Core.Literals {
    ...
    /// <summary>
    /// Literals of type Int64.
    /// </summary>
	/// <seealso cref="Core.Types.Primitives.Int64"/>
	public class Int64Literal: Literal {
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Int64Literal"/> class.
		/// </summary>
		/// <param name="m">The <see cref="Machine"/>.</param>
		/// <param name="x">A given integral value.</param>
		public Int64Literal(Machine m, object x)
		...
		public Int64Literal(Machine m, BigInteger x)
			:base( m, x )
        {
        }
        ...
        public override AType Type {
            get {
				return this.Machine.TypeSystem.GetPrimitiveType( Int64.TypeName );
            }
        }
        ...
        {
			return this.Machine.Bytes.FromIntegralToBytes( this.Value,  Int64.LengthInBytes );
        }
		...
		/// </summary>
		/// <returns>A <see cref="System.String"/> that represents the current <see cref="T:Int64Literal"/>.</returns>
